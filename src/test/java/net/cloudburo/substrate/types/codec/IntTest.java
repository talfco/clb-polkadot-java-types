...
public class IntTest {
    ...
    public void toLittleEndian() throws SubstrateTypeException {
        ...
        // FIXME
        //ui = new Int(ui.toU8Array());
        //assert(BigInteger.valueOf(-6).equals(ui));
        ...
        ui = new Int(ui.toU8Array(),new UIntBitLength(UIntBitLength.UINT_BIT_LENGTH.L16));
        assert(BigInteger.valueOf(6).equals(ui));
        ...
        assert(ui.toRawType().equals("i32"));
        //
        ui = new Int(BigInteger.valueOf(-6),new UIntBitLength(UIntBitLength.UINT_BIT_LENGTH.L16));
        ...
        assert(ui.toRawType().equals("i16"));
    }
