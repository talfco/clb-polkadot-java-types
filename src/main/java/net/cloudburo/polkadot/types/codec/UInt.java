...
import net.cloudburo.polkadot.types.common.*;
...
public class UInt extends AbstractInt {
     ...
     */
    public ScaleBytes toU8() {
        return new ScaleBytes(Helper.bigIntegerToByteArrayWithSize(this,this.getUIntBitLength().inBytes,true));
    }
}
